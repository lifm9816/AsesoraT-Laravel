...
<head>
    ...
    <title>AsesóraT | Modificar Información</title>
...
<body style = "background: url('Fotos/abogados3.jpg');
    ...
    <form action= "{{route('guardar_cambios_abogado')}}" method="POST" enctype ="multipart/form-data">
    {{csrf_field()}}
    <fieldset>
        ...
        <h1><center>Modificar informacion de abogado</center></h1>
        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    @endif
                    <input type = "text" name = "cedula_profesional" value = "{{$consulta ->cedula_profesional}}" class = "form-control" placeholder = "Cédula profesional">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    @endif
                    <input type = "text" name = "telefono" value = "{{$consulta -> telefono}}" class = "form-control" placeholder = "Teléfono">
                </div>
            </div>
        </div>
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <p class = "badge bg-danger">{{$errors->first('Identificación')}}</p>
                     @endif
                    <input type = "file" name = "Identificación" id = "Identificación" value = "{{$consulta -> Identificación}}" class = "form-control" placeholder = "Identificación">
                </div>
            </div>
        </div>
