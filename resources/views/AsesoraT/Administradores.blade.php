...
<head>
    ...
    <title>AsesóraT | Registro Administradores</title>
...
<body style = "background: url('Fotos/cliente.jpg');
    ...
    <form action= "{{route('almacena_administrador')}}" method="POST" enctype ="multipart/form-data">
    {{csrf_field()}}
    <fieldset>
        ...
        <h1><center>Registro de administrador</center></h1>
        ...
        <div class="form-group">
            ...
            @endif
          <input type="text" name ="id" value="{{$idadnuevo}}" readonly ='readonly' class="form-control" placeholder="Escribe la clave del producto">
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    @endif
                    <input type = "text" name = "teléfono" value = "{{old('teléfono')}}" class = "form-control" placeholder = "Teléfono">
                </div>
            </div>
        </div>
